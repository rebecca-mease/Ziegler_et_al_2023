...
% Plots Optotagging data to generate figures for Figure 6b
...
for ct = 1 : size(tbl,1)
    ...
    errorbar(mn(tagged),depth(tagged),sd(tagged), 'horizontal', 'LineStyle', 'none', 'Marker', 'd', 'Color',[1, 0, 0], 'MarkerSize', 2.5, 'LineWidth', 0.01, 'CapSize', 0, 'MarkerFaceColor',[1, 0, 0]);
